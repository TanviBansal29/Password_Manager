...
C_CONFIG_PATH = os.path.join(path_current_directory, "config.yml")
...
class Config:
    ...
    def load_queries(cls):
        with open(Q_CONFIG_PATH, "r") as f:
            ...
            cls.QUERY_TO_CREATE_CREDENTIALS_TABLE = data[
                "QUERY_TO_CREATE_CREDENTIALS_TABLE"
            ]
            ...
            cls.QUERY_TO_VIEW_USER_DATA_BY_WEBSITE = data[
                "QUERY_TO_VIEW_USER_DATA_BY_WEBSITE"
            ]
            ...
            cls.QUERY_TO_UPDATE_DEFAULT_PASSWORD = data[
                "QUERY_TO_UPDATE_DEFAULT_PASSWORD"
            ]
